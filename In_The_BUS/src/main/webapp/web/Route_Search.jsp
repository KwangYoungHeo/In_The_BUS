				...
				<ul>
					<li>
						<div class="titleclickArea">
							<span class="time time1">소요시간</span><br> <span class="payment1"> 요금 </span> <br>
						</div>
						<div class="firstVisible">
							<div class="subwaystation">
								<span class="name1" data-id="name">출발 정류장</span><br>
								<span class="busNo1">노선명</span> <span class="setmin setmin1">
									도착정보</span><br> <span class="stationName1">도착 정류장</span>
								<br>
							</div>
						</div>
					</li>
